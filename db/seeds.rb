Tweet.create!([
                    ...
                    { content: "インスタンスメソッド内でレシーバ自身を代入した変数として扱えるものを選んでください",point:"レシーバを把握しているか",title:"インスタンスメソッド内でレシーバ自身を代入した変数",type_problem: 2,judge_problem1:1,judge_problem2:2,judge_problem3:1,judge_problem4:1,judge_problem5:1,select_problem1:"odd",select_problem2:"self",select_problem3:"this",select_problem4:"build",select_problem5:"new",user_id: 1,answer: "記述問題のため記入なし"},
