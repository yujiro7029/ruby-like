Tweet.create!([
                    { content: "Product.allで取得したインスタンスのクラスとして正しいものを選んでください",point:"ActiveRecordメソッドを把握しているかどうか",title:"ActiveRecordの問題",type_problem: 2,judge_problem1:1,judge_problem2:1,judge_problem3:1,judge_problem4:2,judge_problem5:1,select_problem1:"Array",select_problem2:"String",select_problem3:"Hash",select_problem4:"ActiveRecord::Relation",select_problem5:"group",user_id: 1,answer: "選択問題のため記入なし"},
                    { content: "小数点ありの数値クラスのインスタンスに対して利用出来る小数点以下を四捨五入するメソッドを選んでください",point:"小数点以下を四捨五入するメソッドを把握しているかどうか",title:"小数点以下を四捨五入するメソッド",type_problem: 2,judge_problem1:2,judge_problem2:1,judge_problem3:1,judge_problem4:1,judge_problem5:1,select_problem1:"round",select_problem2:"average",select_problem3:"cell",select_problem4:"floor",select_problem5:"group",user_id: 1,answer: "選択問題のため記入なし"},
                    { content: "インスタンスメソッド内でレシーバ自身を代入した変数として扱えるものを選んでください",point:"レシーバを把握しているか",title:"インスタンスメソッド内でレシーバ自身を代入した変数",type_problem: 2,judge_problem1:1,judge_problem2:2,judge_problem3:1,judge_problem4:1,judge_problem5:1,select_problem1:"odd",select_problem2:"self",select_problem3:"this",select_problem4:"build",select_problem5:"new",user_id: 1,answer: "選択問題のため記入なし"},
                    { content: "あるコントローラのすべてのアクションで実行前に共通の処理を行いときに設定するbefore_actionの使い方として正しいものを選んでください",point:"before_actionの使い方を把握しているかどうか",title:"before_actionの形の問題",type_problem: 2,judge_problem1:2,judge_problem2:1,judge_problem3:1,judge_problem4:1,judge_problem5:1,select_problem1:"before_action :configure_title",select_problem2:"before_action, :configure_title",select_problem3:"before_action: :configure_title",select_problem4:"before_action: configure_title",select_problem5:":before_action: => configure_title",user_id: 1,answer: "選択問題のため記入なし"},
                    { content: "クラスの継承の記述の仕方として正しいものを選んでください",point:"クラス継承の記述を把握しているかどうか",title:"クラスの継承について",type_problem: 2,judge_problem1:1,judge_problem2:1,judge_problem3:2,judge_problem4:1,judge_problem5:1,select_problem1:"class DogController >> AnimalController",select_problem2:"class DogController > AnimalController",select_problem3:"class DogController << AnimalController",select_problem4:"class DogController < AnimalController",select_problem5:"group",user_id: 1,answer: "選択問題のため記入なし"},
                    
                    { content: "application.html.erbの役割と、主な使い方を説明してください。",
                    point:"application.html.erbの役割は何かを把握している",
                    title:"application.html.erbとは",
                    answer: "デフォルトでは、全てのビューが読み込まれるときapplication.html.erbが読み込まれる。そのため、ヘッダーやフッターなど共通で表示させたい内容をここに記述する。",
